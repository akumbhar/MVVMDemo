...
class ExampleInstrumentedTest {
    ...
    fun useAppContext() {
        ...
        assertEquals("com.example.mvvmdiapplication", appContext.packageName)
    }

    private lateinit var observableList: Observable<List<Fact>>
    ...
    fun doSetup() {
        ...
        observableList = Observable.just(apiResponse.rows)
